      ...
      pages={[
        {
          ...
          subtitle: (
            <Text style={styles.text}>
              Its an app that will guide you to become a social butterfly step
              by step
            </Text>
          ),
        },
        {
          ...
          title: (
            <Text style={styles.header}>What is the goal of {Appname}?</Text>
          ),
          subtitle: (
            <Text style={styles.text}>
              We have created 9 chapters to guide you through your process. Each
              chapter comes with tasks and information to educate and guide you
              along the way
            </Text>
          ),
        },
        {
          ...
          title: (
            <Text style={styles.header}>The chapters and their own story</Text>
          ),
