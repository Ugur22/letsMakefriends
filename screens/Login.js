...
const Login = ({navigation}) => {
	...
	return (
		<View style={styles.container}>
			...
			<Button titleStyle={{color: colors.tertiary,fontSize:20,fontStyle:'italic',fontFamily:'PlayfairDisplay-Medium',textDecorationLine:'underline',marginTop:10}}  type="clear" title="What's LetsMakeFriends?" onPress={() => navigation.navigate('Onboarding')}/>
			...
			<View style={{alignItems:'center',justifyContent:'center'}}>
				...
				<Button titleStyle={{color: colors.tertiary,fontStyle:'italic',fontFamily:'PlayfairDisplay-Medium',textDecorationLine:'underline'}} 
