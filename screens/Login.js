...
const Login = ({navigation}) => {
	...
	return (
		<View style={styles.container}>
			...
			<Button titleStyle={{color: colors.primary,fontSize:20,fontStyle:'italic',textDecorationLine:'underline',marginTop:10}}  type="clear" title="What's LetsMakeFriends?" onPress={() => navigation.navigate('Onboarding')}/>
			<Input labelValue={email} onChangeText={(userEmail) => setEmail(userEmail)} leftIcon={ <Icon name='child'size={24} color={colors.primary}/>} keyboardType="email-address" autoCapitalize="none" inputContainerStyle={{marginHorizontal:20}} placeholder="email" />
